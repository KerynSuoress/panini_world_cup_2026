    ...
    <label className="block">
      ...
      <div className="relative">
        <select
          ...
          className="w-full appearance-none rounded-2xl border border-white/60 bg-white/80 pl-4 pr-10 py-3 text-sm shadow-sm outline-none focus:ring-2 focus:ring-[var(--color-primary)] transition-colors"
        >
