...
- **Migration:** `drizzle/0002_history.sql` — journal `when` must be **after** `0001_trade_requests` or Drizzle silently skips it (Drizzle compares timestamps, not file order).
